    ...
    public function run()
    {
        ...
        $lots = [
            ...
            [
                ...
                'date_mise_en_bouteille' => Carbon::now()->subDays(80)->format('Y-m-d'),
                'date_commercialisation' => null,
            ...
            [
                ...
                'date_mise_en_bouteille' => Carbon::now()->subDays(35)->format('Y-m-d'),
                'date_commercialisation' => Carbon::now()->subDays(5)->format('Y-m-d'),
            ...
            [
                ...
                'date_mise_en_bouteille' => Carbon::now()->subDays(100)->format('Y-m-d'),
                'date_commercialisation' => null,
